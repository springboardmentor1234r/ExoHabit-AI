...
![ExoHabit Banner](https://img.shields.io/badge/EXOHABIT-AI-000000?style=for-the-badge&logo=nasa&logoColor=00d4ff&labelColor=000000)
...
|:---|:---|:---|
| **Frontend** | HTML5, CSS3, JS (ES6+) | Glassmorphism UI, Responsive Design |
| **Visuals** | Three.js, GSAP | 3D Particles & Smooth Animations |
| **Backend** | Python, Flask | RESTful API Architecture |
| **AI/ML** | Scikit-Learn, XGBoost | Probabilistic Classification Models |
| **Data** | NASA Exoplanet Archive | Trained on 5,000+ confirmed planets |
...
|:---:|:---:|
| <div align="center"><i>Interactive 3D Starfield</i></div> | <div align="center"><i>Real-time Habitability Analysis</i></div> |
